...
<html>
    ...
    <body class="no-skin">
        ...
        <c:if test="${param.btnAction == null}">
            <c:redirect url="MainController?btnAction=Update_Page" />
        </c:if>
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            <span class="red">Update Product</span>
                        </h1>
                    </div>
                                    ...
                                    <form action="MainController" method="POST" enctype="multipart/form-data">
                                        <fieldset>
                                            <label class="block clearfix">
                                                ...
                                                <input type="text" class="form-control" placeholder="A001, B125,..." name="productCode" readonly="" value="${requestScope.productCode}"/>
                                            </label>
                                            ...
                                            <p><img src="${requestScope.image}" id="output" width="125"/></p>
                                            ...
                                            <div class="clearfix">
                                                <button style="margin-left: 37px" type="submit" class="width-65 btn btn-sm btn-success" name="btnAction" value="Update_Product">
