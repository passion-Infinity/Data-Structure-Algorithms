...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = Action.LOGIN_PAGE.getAction();
        ...
        try {
            ...
            if (valid) {
                ...
                if (dto != null && dto.getStatus().equals("New")) {
                    session.setAttribute("email", null);
                    session.setAttribute("accountErr", null);
                    session.setAttribute("loginError", null);
                    session.setAttribute("account", dto);
                    url = Action.HOME.getAction();
                } else {
                    session.setAttribute("loginError", "Wrong email or password. Please try again!");
                }
            } else {
